                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="myTable">
                                ...
                                @foreach($category as $item)
                                    ...
                                    <tr>
                                        <td>{{$item->name }}</td>
                                        <td>{{$item->slug}}</td>
                                        <td>  <img src=" {{ asset('storage/CategoryImages/'. $item->icon) }}" alt="Interest Icon" width="50" height="50"></td>

                                        <td>
                                            <label class="switch">
                                                <input type="checkbox" class="toggle-class-2" data-id="{{ $item->id }}" {{ $item->status ? 'checked' : '' }}>
