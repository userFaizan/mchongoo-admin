    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Edit</strong> Plan</h2>
                    </div>
                    <div class="body">
                        <form id="ajax-request" method="post" action="{{route('plans.update',$plan->id)}}" enctype="multipart/form-data" class="" data-redirect-url="{{ route('plans.index') }}">
                            @csrf
                            <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="plan_amount" name="plan_amount" class="form-control" value="{{$plan->plan_amount}}" placeholder="Enter your Plan Amount">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="plan_duration" name="plan_duration" class="form-control"  value="{{$plan->plan_duration}}" placeholder="Enter your Plan Duration">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
